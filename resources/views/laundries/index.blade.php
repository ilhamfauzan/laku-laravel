<x-app-layout>
        ...
        <div class="max-w-7xl mx-auto sm:px-4 lg:px-8">
            ...
            @else
                <div class="mt-6">
                    ...
                    <p class="text-sm text-gray-500 mb-4">The following laundry orders are still in progress and have
                        not been completed yet.</p>
                                ...
                                @foreach ($laundries->where('status', 'Unfinished') as $laundry)
                                    <tr class="hover:bg-gray-100 transition-colors duration-200">
                                        ...
                                        <td class="py-2 px-4 border-b">
                                            Rp{{ number_format($laundry->laundry_weight * $laundry->service->service_price, 0, ',', '.') }}
                                        </td>
                                        ...
                                        <td class="py-2 px-4 border-b">
                                            ...
                                            <button onclick="openDetailModal({{ $laundry }})"
            ...
            @else
                <div class="mt-6">
                    ...
                    <p class="text-sm text-gray-500 mb-4">The following laundry orders are finished but have not been
                        picked up yet.</p>
                    <div class="overflow-x-auto">
            ...
            <div id="paidModal"
                ...
                <div class="relative p-5 border w-full max-w-md shadow-lg rounded-md bg-white border-gray-300">
                    <div class="mt-3 text-center">
                        ...
                        <div class="mt-2">
                            <p class="text-sm text-gray-500">Are you sure you want to mark this transaction as paid?
                    ...
                    <div class="mt-3">
                        <form id="laundryForm" method="POST" class="mt-4">
                            ...
                            <div class="mb-2">
                                ...
                                <input type="number" name="customer_phone_number" id="customer_phone_number"
                            ...
                            <div class="mb-2">
                                ...
                                <input type="number" step="0.1" name="laundry_weight" id="laundry_weight"
                                    required placeholder="Enter laundry weight"
                                    class="w-full rounded-md bg-gray-100 border-gray-300 text-gray-700 focus:ring"
                                ...
                                <select name="service_id" id="service_id" required
                                    ...
                                    @foreach ($services as $service)
                                        <option value="{{ $service->id }}"
                                            data-price="{{ $service->service_price }}">{{ $service->service_name }}
                                            (Rp{{ $service->service_price }}/kg)
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="mb-2">
                                ...
                                <textarea name="description" id="description" placeholder="Enter description"
                                    class="w-full rounded-md bg-gray-100 border-gray-300 text-gray-700 focus:ring"></textarea>
                            </div>
                            <div class="mb-4">
    ...
    <div id="deleteModal"
        ...
        <div class="relative p-5 border w-full max-w-md shadow-lg rounded-md bg-white border-gray-300">
            <div class="mt-3 text-center">
                ...
                <div class="mt-2">
                    <p class="text-sm text-gray-500">Are you sure you want to delete this laundry? This action cannot
                        be undone.</p>
                </div>
                <div class="mt-4 flex justify-center">
    ...
    <div id="finishModal"
        ...
        <div class="relative p-5 border w-full max-w-md shadow-lg rounded-md bg-white border-gray-300">
            <div class="mt-3 text-center">
                ...
                <div class="mt-2">
                    <p class="text-sm text-gray-500">Are you sure you want to mark this laundry as finished? This
    ...
    <script>
        ...
        function updateTotalCost() {
            ...
            const servicePrice = parseFloat(serviceSelect.options[serviceSelect.selectedIndex].getAttribute(
                'data-price')) || 0;
