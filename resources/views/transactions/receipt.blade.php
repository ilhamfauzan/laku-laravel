...
<head>
    ...
    <style>
        ...
        .receipt-container {
            width: 80mm; /* Small receipt width */
            margin: 0 auto;
            padding: 10px;
...
<body>
    <div class="receipt-container">
        ...
        <div class="receipt-details">
            ...
            <p style="text-align: center"><b>ID:</b> {{ $transaction->id }} || <b>Cashier:</b> {{ Auth::user()->name }}</p>
            <p style="text-align: center">===================================</p>
            <br>
            ...
            <td style="text-align: left">{{ substr($transaction->laundry->customer_phone_number, 0, 3) . '*******' . substr($transaction->laundry->customer_phone_number, -4) }}</td>
            </tr>
            <tr>
